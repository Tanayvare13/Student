...
class Register_stud:
    def __init__(self,root):
        ...
        #--------Bg Image----------------
        self.bg = ImageTk.PhotoImage(file=r"Student_Result_Management_System\images\b2.jpg")
        bg = Label(self.root,image=self.bg).place(x=250,y=0,relwidth=1,relheight=1)

        #--------Left Image----------------
        self.left = ImageTk.PhotoImage(file=r"Student_Result_Management_System\images\side.png")
        ...
        self.btn_image = ImageTk.PhotoImage(file=r"Student_Result_Management_System\images\register.png")
